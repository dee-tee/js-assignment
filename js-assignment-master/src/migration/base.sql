...
CREATE INDEX idx_news_matchId ON news(matchId);
CREATE INDEX idx_news_tourId ON news(tourId);
CREATE INDEX idx_news_sportId ON news(sportId);
...
INSERT IGNORE INTO mydb.news (title, description, matchId, tourId, sportId)
VALUES 
    ('Breaking News 1', 'Description for breaking news 1', 1, 1, 1),
    ('Latest Update 2', 'Description for latest update 2', 2, 2, 2),
    ('Latest Update 3', 'Description for latest update 3', 3, 3, 1);
